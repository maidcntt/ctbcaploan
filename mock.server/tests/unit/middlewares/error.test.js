...
describe('Error middlewares', () => {
  describe('Error converter', () => {
    ...
    test('should convert a Sequelize validation error to ApiError with status 400 and preserve its message', () => {
      const error = new sequelize.ValidationError('Any sequelize validation error');
